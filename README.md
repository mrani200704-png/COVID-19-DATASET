...
This project performs COVID-19 data analysis and visualization using Python.
It loads a COVID-19 dataset, cleans the data, calculates statistics, and creates charts to understand the spread and impact of the pandemic.
...
Analyze top affected countries
Create:
Bar Chart
Pie Chart
Scatter Plot
...
How to Run
Place covid_19_data.csv in the same folder as the Python script.
Run the Python file:
...
Line Graph
Sample Output
Total Confirmed Cases: XXXXX
Total Deaths: XXXXX
Total Recovered: XXXXX

Analysis Completed Successfully!
Future Improvements
Add real-time COVID-19 API data
Build interactive dashboards
Add prediction models using Machine Learning
Create country-wise filters
Conclusion
